...
mse_vals_before = [55.93, 54.69, 78.85]
psnr_vals_before = [30.76, 30.87, 29.25]
ssim_vals_before = [0.7799, 0.7866, 0.7651]

# After light correction 
mse_vals_after = [66.37, 53.00, 102.23]
psnr_vals_after = [30.05, 31.10, 28.07]
ssim_vals_after = [0.8061, 0.8087, 0.7276]
