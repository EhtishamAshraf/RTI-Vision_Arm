"""
This module contains the dataset class for loading and processing images.
It includes functions for converting between Cartesian and spherical coordinates for light positions.
The dataset class loads the LP file, image paths, and images, and provides methods.
"""
import numpy as np
import os
import glob
...
class dataset:
    ...
    def load_images(self):
        ...
        print(f"[INFO] Final image stack shape: {self.images.shape}")
