"""
This module contains the code for fitting and using a Discrete Model Decomposition (DMD) model.
The DMD model is used for relighting images based on light positions in spherical coordinates.
It includes methods for fitting the model to target images and relighting images
using the fitted coefficients. Unlike PTM or HSH, DMD directly models reflectance
using a linear combination of the captured images under discrete lighting directions.
"""
