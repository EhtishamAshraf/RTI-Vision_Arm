"""
This module contains the code for fitting and using a Hemispherical Harmonics (HSH) model.
The HSH model is used for relighting images based on light positions in Spherical coordinates.
It includes methods for computing the HSH basis, fitting the model to target images,
